...
//     vector<int> closest(n, -1);
//     for (int i = 0; i < leaves.size(); i ++) {
//         if (find(pots.begin(), pots.end(), leaves[i]) != pots.end()) {
//             closest[i] = leaves[i];
//         } else {
//             for (int j = 0; i < ancestors[i].size(); j++) {
//                 if (find(pots.begin(), pots.end(), ancestors[i][j]) != pots.end()) {
//                     closest[i] = ancestors[i][j];
//                     break;
//                 }
//             }
//         }
//     }
//     set<int> distinct(closest.begin(), closest.end());
//     int ans = distinct.size();
//     cout << ans;
